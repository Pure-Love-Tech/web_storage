...
class AdminWithdrawalNotification extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
            ->subject(mailTemplate('admin_withdrawal_notification')->subject)
            ->markdown('emails.default', [
                'body' => mailTemplate('admin_withdrawal_notification')->body,
                'short_codes' => [
