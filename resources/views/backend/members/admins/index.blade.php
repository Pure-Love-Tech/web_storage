...
@section('title', admin_trans('Admins'))
            ...
            <table id="datatable" class="table w-100">
                <thead>
                    <tr>
                        ...
                        <th class="tb-w-20x">{{ admin_trans('Details') }}</th>
                        <th class="tb-w-3x">{{ admin_trans('Added date') }}</th>
                        <th></th>
                    </tr>
                </thead>
                <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="vironeer-user-box">
                                    ...
                                    <div>
                                        <a class="text-reset"
                                            href="{{ route('admin.members.admins.edit', $admin->id) }}">{{ $admin->firstname . ' ' . $admin->lastname }}</a>
