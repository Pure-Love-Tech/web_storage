 ...
 <link rel="stylesheet" href="{{ asset('vendor/libs/sweetalert/sweetalert2.min.css') }}">
 @stack('styles_libs')
 ...
 <link rel="stylesheet" href="{{ asset('vendor/libs/select2/select2-bootstrap-5-theme.css') }}">
