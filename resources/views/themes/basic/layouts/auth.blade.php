...
<body>
    ...
    <header class="header">
        <div class="wrapper wrapper-page wrapper-page-bg">
            <div class="header-wave">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 63.156" preserveAspectRatio="none">
                    <path class="cls-1"
    ...
    @elseif(session('resent'))
        <script>
            toastr.success('{{ translate('Link has been resend Successfully', 'auth') }}')
        </script>
    @endif
