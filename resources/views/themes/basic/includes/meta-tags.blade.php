...
$keywords = $__env->yieldContent('keywords') ? $__env->yieldContent('keywords') : $seoConfiguration->keywords ?? '';
...
@if($seoConfiguration)
<meta name="robots" content="{{ $seoConfiguration->robots_index . ', ' . $seoConfiguration->robots_follow_links }}">
@endif
