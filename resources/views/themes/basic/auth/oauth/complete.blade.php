...
@section('title', translate('Complete your information', 'auth'))
@section('content')
    <div class="row">
        <div class="col-lg-6 m-auto">
            <div class="section-header">
                <h2 class="section-title text-capitalize mb-0">{{ translate('Complete your information', 'auth') }}</h2>
            </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-icon radius">
                            ...
                            <input type="text" name="username" class="form-control form-control-md"
                                value="{{ auth()->user()->username }}" placeholder="{{ translate('Username', 'forms') }}"
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-icon radius">
                            ...
                            <input type="email" name="email" class="form-control form-control-md"
                                value="{{ auth()->user()->email }}" placeholder="{{ translate('Email address', 'forms') }}"
                                required />
                        </div>
                    </div>
                    <div class="mb-3">
