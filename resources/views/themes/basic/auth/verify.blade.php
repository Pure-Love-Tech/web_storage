    ...
    <div class="row my-4">
        <div class="col-lg-6 m-auto">
            <div class="section-header">
                <h2 class="section-title text-capitalize mb-0">{{ translate('Verify Your Email Address', 'auth') }}</h2>
            </div>
            <div class="section-body">
                ...
                <div>
                    ...
                    <form class="d-inline" method="POST" action="{{ route('verification.resend') }}">
                        @csrf
                        <button type="submit"
                            class="btn btn-primary btn-md me-2">{{ translate('Resend', 'auth') }}</button>
                    </form>
                    <button href="#" class="btn btn-outline-secondary btn-md" data-bs-toggle="modal"
                ...
                <form action="{{ route('change.email') }}" method="POST">
                    ...
                    <div class="modal-body p-0">
                        ...
                        <div class="row justify-content-center g-3">
                            ...
                            <div class="col-12 col-lg">
                                <button type="submit"
                                    class="btn btn-primary btn-md w-100">{{ translate('Save', 'auth') }}</button>
                            </div>
                        </div>
                    </div>
                </form>
