...
@section('section', translate('Password', 'password page'))
        ...
        <div class="container">
            <div class="section-inner">
                <div class="section-body">
                    <div class="col-md-6 col-lg-5 col-xl-4 m-auto">
                        <div class="card-v">
                            <div class="file-password">
                                <div class="file-password-img mb-4">
                                    <svg xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" width="866.52362"
                                        ...
                                        <path d="M971.73819,768.52814v-72.34S999.92985,747.47411,971.73819,768.52814Z"
                                            transform="translate(-166.73819 -131.47186)" fill="#f1f1f1"></path>
                                        <path
                                        ...
                                        <path
                                            ...
                                            transform="translate(-166.73819 -131.47186)" fill="#ffb7b7"></path>
                                        <polygon
                                        ...
                                        <path
                                            ...
                                            transform="translate(-166.73819 -131.47186)" fill="#2f2e41"></path>
                                        <polygon
                                        ...
                                        <path
                                            ...
                                            transform="translate(-166.73819 -131.47186)" fill="#cbcbcb"></path>
                                        <path
                                        ...
                                        <path
                                            ...
                                            transform="translate(-166.73819 -131.47186)" fill="#e5e5e5"></path>
                                        <path
                                            ...
                                            transform="translate(-166.73819 -131.47186)" class="icon-color"></path>
                                ...
                                <p class="text-center">
                                    {{ translate('Enter password to unlock the file', 'password page') }}</p>
                                <div class="file-password-form">
                                    <form action="{{ route('files.password', $fileEntry->sharedId()) }}" method="POST">
                                        @csrf
                                        <div class="input-group input-icon input-password mb-3">
                                            <input type="password" name="password"
                                                class="form-control form-control-md radius radius-md"
                                                placeholder="{{ translate('Enter the password', 'password page') }}"
                                                required>
                                        ...
                                        <button
                                            class="btn btn-primary btn-md w-100 radius radius-md">{{ translate('Unlock', 'password page') }}</button>
                                    </form>
                                </div>
                            </div>
                        </div>
