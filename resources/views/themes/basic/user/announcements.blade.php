...
@section('title', translate('Announcements', 'announcements'))
@section('content')
    <div class="announcement-card card-v">
                    ...
                    <div class="row row-cols-auto gx-3 gy-2 align-items-center">
                        <div class="col">
                            <div class="announcement-time">
                                <span>{{ dateFormat($announcement->created_at) }}</span>
                            </div>
                        </div>
                        <div class="col">
        ...
        @empty
            <div class="col-lg-6 m-auto py-5 text-center">
                <div class="mb-4">
                    <svg xmlns="http://www.w3.org/2000/svg" width="150" height="150" viewBox="0 0 647.63626 632.17383"
                ...
                <h4>{{ translate('No Announcements Available', 'announcements') }}</h4>
                <p class="mb-0">
