...
@section('title', admin_trans('Permissions'))
@section('content')
        ...
        <div class="mt3">
            @if (!$error)
                <div class="alert alert-success">
                    ...
                    {{ admin_trans('All permissions are enabled you can continue to next step') }}
                </div>
            ...
            @else
                <div class="alert alert-danger">
                    ...
                    {{ admin_trans('Some permissions are missing please give 0775 permission to all files above.') }}
                </div>
                <button class="btn btn-primary btn-md" disabled>{{ admin_trans('Continue') }}<i
                        class="fas fa-arrow-right ms-2"></i></button>
            @endif
        </div>
    </div>
