...
<head>
    ...
    <link rel="icon" href="{{ asset('vendor/install/img/favicon.ico') }}" type="image/png" />
    <title>{{ admin_trans('Vironeer Installer') }} - @yield('title')</title>
    ...
    <link rel="stylesheet" href="{{ asset('vendor/install/css/application.min.css') }}" />
</head>
        ...
        <div class="container">
            <div class="vironeer-navbar-inner">
                <a href="https://vironeer.com" class="vironeer-logo" target="_blank">
                    <img src="{{ asset('vendor/install/img/logo.png') }}" alt="Vironeer" />
                </a>
                <div class="vironeer-navbar-actions">
                    <a href="https://t.me/vironeer" class="btn btn-light btn-md"
                        target="_blank">{{ admin_trans('Get Help') }}</a>
                </div>
            </div>
        </div>
    </nav>
                    ...
                    <div class="vironeer-steps col-xxl-8 mx-auto">
                        <div class="vironeer-steps-header">
                            <div class="vironeer-steps-item {{ currentStep(1) }}">
                                ...
                                <div class="vironeer-steps-item-text">{{ admin_trans('Requirements') }}</div>
                            </div>
                            <div class="vironeer-steps-item {{ currentStep(2) }}">
                                ...
                                <div class="vironeer-steps-item-text">{{ admin_trans('Permissions') }}</div>
                            </div>
                            <div class="vironeer-steps-item {{ currentStep(3) }}">
                                ...
                                <div class="vironeer-steps-item-text">{{ admin_trans('License') }}</div>
                            </div>
                            <div class="vironeer-steps-item {{ currentStep(4) }}">
                                ...
                                <div class="vironeer-steps-item-text">{{ admin_trans('Database') }}</div>
                            </div>
                            <div class="vironeer-steps-item {{ currentStep(5) }}">
                                ...
                                <div class="vironeer-steps-item-text">{{ admin_trans('Import') }}</div>
                            </div>
                            <div class="vironeer-steps-item {{ currentStep(6) }}">
                                ...
                                <div class="vironeer-steps-item-text">{{ admin_trans('Completed') }}</div>
                            </div>
                        </div>
                        @yield('content')
                    </div>
            ...
            <div class="row justify-content-sm-between align-items-center g-3">
                <div class="col-12 col-sm-auto">
                    <p class="text-muted text-center mb-0 small">
                        {{ admin_trans('Vironeer') }} © <span data-year></span> -
                        {{ admin_trans('All rights reserved') }}
                    </p>
                </div>
                <div class="col-12 col-sm-auto">
                    <div class="vironeer-footer-links">
                        <a href="https://codecanyon.net/user/vironeer" class="link">{{ admin_trans('Envato') }}</a>
                        <a href="https://twitter.com/vironeer" class="link">{{ admin_trans('Twitter') }}</a>
                        <a href="https://t.me/vironeer" class="link">{{ admin_trans('Get Help') }}</a>
                    </div>
                </div>
            </div>
        </div>
