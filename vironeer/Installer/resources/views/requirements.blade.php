...
@section('title', admin_trans('Requirements'))
@section('content')
        ...
        <div class="mt-3">
            @if (!$error)
                <div class="alert alert-success">
                    ...
                    {{ admin_trans('All extensions are enabled you can continue to next step') }}
                </div>
            ...
            @else
                <div class="alert alert-danger">
                    ...
                    {{ admin_trans('Some extensions are required please enable them before you can continue.') }}
                </div>
